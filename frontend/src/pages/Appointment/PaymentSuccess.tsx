...
const PaymentSuccess: React.FC = () => {
  ...
  const appointment = location.state?.appointment as
    | AppointmentDetails
    | undefined;
    ...
    return (
      <div className="min-h-screen bg-mnkhan-gray-bg flex items-center justify-center px-4">
        <div className="bg-white border border-mnkhan-gray-border rounded-lg p-8 shadow-sm text-center max-w-md">
          ...
          <h2 className="text-2xl font-serif text-mnkhan-charcoal mb-4">
            No Appointment Found
          </h2>
          <p className="text-mnkhan-text-muted mb-6">
            We couldn't find your appointment details. Please check your email
            for confirmation.
          </p>
          <Link
            to="/"
      ...
      <div className="max-w-2xl w-full relative z-10">
        ...
        <div className="bg-white border border-mnkhan-gray-border rounded-lg p-8 shadow-sm text-center">
          ...
          <h1 className="text-4xl font-serif text-mnkhan-charcoal mb-4">
            Payment{" "}
            <span className="text-mnkhan-orange italic">Successful!</span>
          </h1>
          ...
          <div className="bg-mnkhan-gray-bg rounded-lg p-6 mb-8 text-left border border-mnkhan-gray-border">
            <h3 className="text-lg font-serif text-mnkhan-charcoal mb-4 text-center border-b-2 border-mnkhan-orange pb-2 inline-block w-full">
              Appointment Details
            </h3>
            ...
            <div className="space-y-3 mt-4">
              <div className="flex justify-between items-center py-2 border-b border-mnkhan-gray-border">
                ...
                <span className="text-mnkhan-charcoal font-bold">
                  {formattedDate}
                </span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-mnkhan-gray-border">
          ...
          {appointment.googleMeetLink && (
            <div className="bg-mnkhan-charcoal rounded-lg p-6 mb-8">
              <div className="flex items-center justify-center mb-4">
                <svg
                  className="w-8 h-8 text-mnkhan-orange mr-2"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
          ...
          <div className="bg-amber-50 rounded-lg p-4 mb-8 border border-amber-200">
            ...
            <p className="text-amber-800 text-sm">
              A confirmation email with calendar invite has been sent to your
              email address. Add it to your calendar to receive reminders.
            </p>
          </div>
        ...
        <p className="text-center text-mnkhan-text-muted text-sm mt-6">
          ...
          <a
            href="mailto:support@mnkhan.online"
            className="text-mnkhan-orange hover:underline font-bold"
          >
            support@mnkhan.online
          </a>
        </p>
      </div>
    </div>
