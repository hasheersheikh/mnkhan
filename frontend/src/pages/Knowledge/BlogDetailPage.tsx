  ...
  if (error || !blog)
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-8">
        ...
        <p className="text-mnkhan-text-muted mb-8">
          {error || "Article not found"}
        </p>
        <Link
          to="/knowledge"
          className="bg-mnkhan-charcoal text-white px-8 py-3 font-bold uppercase tracking-widest text-xs"
        >
          Back to Knowledge
        </Link>
      </div>
    ...
    <div className="bg-white min-h-screen pb-32">
      ...
      <section className="bg-mnkhan-charcoal py-24 text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 relative z-10 text-center">
          <Link
            to="/knowledge"
            className="text-mnkhan-orange font-bold uppercase tracking-widest text-[10px] mb-8 block hover:underline"
          >
            ← Knowledge Center
          </Link>
          <p className="text-mnkhan-orange font-bold uppercase tracking-[0.3em] text-[10px] mb-6">
            {blog.category}
          </p>
        ...
        <div className="bg-white p-12 md:p-20 border border-mnkhan-gray-border shadow-xl rounded-sm">
          ...
          <div className="mt-20 pt-12 border-t border-mnkhan-gray-border flex flex-col items-center gap-8">
            ...
            <p className="text-center text-mnkhan-text-muted italic max-w-lg">
              &copy; 2026 MN KHAN . All rights reserved. The information
              provided above is for educational purposes and does not constitute
              legal advice.
              <br />
              Developed by{" "}
              <a
                ...
                className="text-mnkhan-orange hover:underline"
              >
            ...
            <Link
              to="/knowledge"
              className="mt-4 text-mnkhan-orange font-bold uppercase tracking-widest text-[10px] hover:underline"
            >
