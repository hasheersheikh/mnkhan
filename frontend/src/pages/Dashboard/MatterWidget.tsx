...
const MatterWidget: React.FC<MatterWidgetProps> = ({ tasks, loading }) => {
  return (
    <div className="col-span-12 lg:col-span-8 bg-white p-6 rounded border border-mnkhan-gray-border hover:translate-y-[-2px] hover:shadow-lg transition-all duration-200 min-h-[300px]">
      ...
      <div className="space-y-6">
        {loading ? (
          ...
          <p className="italic text-mnkhan-text-muted py-8 text-center text-sm">
