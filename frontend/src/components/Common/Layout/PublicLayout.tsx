...
const PublicLayout: React.FC<PublicLayoutProps> = ({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <footer className="relative z-10 bg-mnkhan-charcoal text-white py-12 px-6 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 md:gap-8">
          <div>
            <div className="mb-4">
              ...
              <span className="block text-[8px] md:text-[10px] font-semibold uppercase text-gray-400 tracking-[0.55em] -mt-1">
                & Associates
              </span>
            </div>
            <p className="text-sm text-gray-400 max-w-xs">
              Legal excellence across India. Dedicated to providing innovative
              legal solutions for complex challenges.
            </p>
          </div>
          <div className="grid grid-cols-2 md:flex md:flex-row gap-8 md:gap-12 w-full md:w-auto">
            <div className="flex flex-col gap-3 text-sm">
              <span className="text-[10px] font-bold uppercase tracking-widest text-mnkhan-orange mb-1">
                Quick Links
              </span>
              <Link
                to="/services"
